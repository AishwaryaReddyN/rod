...
INSERT INTO `chatbot` (`id`, `queries`, `replies`) VALUES ('1', 'How to apply for St. Francis College?', 'https://www.sfc.ac.in/admissions.php\r\nclick on the link to view the admission form. The application fee is Rs.500/- for the candidates who are applying.'), 
('2', 'How can I get admitted into St. Francis College?', 'For UG Program all the students must appear for the entrance exam which is conducted every year.For PG program all students must attend an interview which is conducted every year.'),
('3', 'What is the dress code at St. Francis?', 'The dress code at St. Francis is full length kurtis. However , sleeveless tops , shorttops are not encouraged.'),
('4', 'Is hostel facility available in campus?', 'No,Hostel facility is not available in campus.'),
('5', 'Is St. Francis Autonomous?', 'The college remains affiliated to Osmania University ,it is autonomous at the UG and PG level.'),
('6', 'What are the placement opportunities at St. Francis?', 'The placement cell in the college ensures that most of the students get placed. About 90% of the students get placed every year. Many internship opportunities were provided in various sectors.'),
('7', 'What is the fee structure of St. Francis?', 'St.Francis is a multi-disciplinary institution, and as several programs with distinct fee structures. you can check out the fee structure for your desired program by visiting our fee structure page. Or contact us at +914023403200/23400470'),
('8', 'What is the eligibilty criteria for admissions?', 'https://www.sfc.ac.in/admissions.php Click on the link to view the eligibility criteria for various courses'),
('9', 'Is parking facility available in the campus?', 'students are allowed to park only two wheeler inside the campus, while staff can park two and four wheeler inside campus'),
('10', 'What extracurricular opportunities are available?', 'The college provides various extracurricular oppurtunities such as NCC, NSS, sports from which it is mandatory for first year UG students to opt one of these. St.Francis also provides a broad assortment of other activities- artistic, musical,political and social.');
