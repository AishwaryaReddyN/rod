...
INSERT INTO `announcements` (`announcement_title`, `announcement_message`, `announcement_date`, `announcement_time`, `announcement_id`, `user_id`) VALUES('Announcement Title Three', 'This is a sample message3', '2023/02/10', '14:19', '30ca93a4-1c64-461c-9df5-227a50146a4d', 2);

-- Chatbot Seeder
INSERT INTO `chatbot` (`queries`, `replies`) VALUES ('How to apply for St. Francis College?', 'Click <a href="https://www.sfc.ac.in/admissions.php">here</a> to view the admission form. The application fee is Rs.500/- for the candidates who are applying.'), 
...
('What is the eligibilty criteria for admissions?', 'Click <a href="https://www.sfc.ac.in/admissions.php">here</a> to view the eligibility criteria for various courses'),
