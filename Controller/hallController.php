...
if (isset($_REQUEST["searchHalls"])) {
    ...
    $searchedHalls = retrieveHalls($conn, $hallName, $first_day_this_month, $last_day_this_month);
...
if (isset($_REQUEST['bookHall'])) {
    ...
    insertOne($conn, "hall_bookings", ["hall_name", "hall_booking_date", "hall_booking_time", "hall_booking_purpose", "booking_user_id"], [$hallName, $hallBookingDate, $hallBookingTime, $hallBookingPurpose, $userId]);
